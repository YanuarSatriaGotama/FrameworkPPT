...
Route::get('/pzn', function () {
    return "Hello Acun_satria";
});

Route::redirect('/youtube', '/pzn');

Route::fallback(function () {
    return "404 by Acun_satria";
});

Route::view('/hello', 'hello', ['name' => 'Yanuar']);

Route::get('/hello-again', function () {
    return view('hello', ['name' => 'Yanuar']);
});

Route::get('/hello-world', function () {
    return view('hello.world', ['name' => 'Yanuar']);
});
...
Route::get('/conflict/Yanuar', function () {
    return "Conflict Yanuar Satria Eka candra";
});
...
Route::get('/redirect/named', function () {
    return \Illuminate\Support\Facades\URL::route('redirect-hello', ['name' => 'Yanuar']);
});
