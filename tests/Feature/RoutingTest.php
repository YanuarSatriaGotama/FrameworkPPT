...
class RoutingTest extends TestCase
{
    public function testGet()
    {
        $this->get('/pzn')
            ->assertStatus(200)
            ->assertSeeText('Hello Acun_satria');
    }
    ...
    {
        $this->get('/tidakada')
            ->assertSeeText('404 by Acun_satria');
    ...
    public function testRouteParameterRegex()
    {
        ...
        $this->get('/categories/Yanuar')
            ->assertSeeText('404 by Acun_satria');
    }

    public function testRouteParameterOptional()
    {
        $this->get('/users/Yanuar')
            ->assertSeeText('User Yanuar');
    ...
    public function testRouteConflict()
    {
        ...
        $this->get('/conflict/Yanuar')
            ->assertSeeText("Conflict Yanuar");
    }
