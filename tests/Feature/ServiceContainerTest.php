...
class ServiceContainerTest extends TestCase
{
    ...
    public function testBind()
    {
        ...
        $person1 = $this->app->make(Person::class); // closure() // new Person("Yanuar", "Satria");
        $person2 = $this->app->make(Person::class); // closure() // new Person("Yanuar", "Satria");
    ...
    public function testSingleton()
    {
        ...
        $person1 = $this->app->make(Person::class); // new Person("Yanuar", "Satria"); if not exists
    ...
    public function testInterfaceToClass()
    {
        ...
        self::assertEquals('Halo Yanuar', $helloService->hello('Yanuar'));
    }
}
